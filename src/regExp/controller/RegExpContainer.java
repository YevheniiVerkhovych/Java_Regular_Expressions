...
interface RegExpContainer {
    ...
    String patternSubscriberLogin                  = "[\\w0-9-\\.]{1,30}";
...
//  String patternSubscriberGroups                 = "";
    ...
    String patternSubscriberEmail                  = "[\\w0-9-\\.]{1,50}@[A-Za-z0-9-.]{1,50}.([A-Za-z]){2,4}";
    String patternSubscriberSkype                  = "[\\w0-9-\\.]{1,30}";
    String patternSubscriberZipCode                = "\\d{5,7}";
    String patternSubscriberCity                   = "^[А-ЯҐІЇЄ]{1}[а-яґіїє']{1,20}+(-[А-ЯҐІЇЄ]{1}[а-яґіїє']{1,20})?";
    String patternSubscriberStreet                 = "^[А-ЯҐІЇЄ]{1}[а-яґіїє']{1,20}+((-|\\s){1}[А-ЯҐІЇЄ]{1}[а-яґіїє']{1,20})?";
